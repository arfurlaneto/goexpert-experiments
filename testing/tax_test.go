// pode ter o mesmo nome do pacote principal ou ser "test"
package tax
...
func BenchmarkCalculateTaxBatch2(b *testing.B) {
	for i := 0; i < b.N; i++ {
		CalculateTax2(500.0)
	}
}
...
func FuzzCalculateTax(f *testing.F) {
	seed := []float64{-200000.0, -1000.0, -2.0, 0, 2.0, 1000.0, 200000.0}
